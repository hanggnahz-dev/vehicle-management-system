import Joi from 'joi';
export declare const validateUserData: (data: any) => Joi.ValidationResult<any>;
export declare const validateUpdateUserData: (data: any) => Joi.ValidationResult<any>;
export declare const validateVehicleData: (data: any) => Joi.ValidationResult<any>;
